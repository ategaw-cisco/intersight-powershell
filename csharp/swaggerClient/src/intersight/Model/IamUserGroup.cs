...
namespace intersight.Model
{
    ...
    public partial class IamUserGroup :  IEquatable<IamUserGroup>, IValidatableObject
    {
        ...
        public IamUserGroup(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamIdpRef Idp = default(IamIdpRef), IamIdpReferenceRef Idpreference = default(IamIdpReferenceRef), string Name = default(string), List<IamPermissionRef> Permissions = default(List<IamPermissionRef>), IamQualifierRef Qualifier = default(IamQualifierRef), List<IamUserRef> Users = default(List<IamUserRef>))
        {
