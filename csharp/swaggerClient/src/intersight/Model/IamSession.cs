...
namespace intersight.Model
{
    ...
    public partial class IamSession :  IEquatable<IamSession>, IValidatableObject
    {
        ...
        public IamSession(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<IamAccountPermissions> AccountPermissions = default(List<IamAccountPermissions>), IamPermissionRef Permission = default(IamPermissionRef), IamUserRef User = default(IamUserRef))
        {
