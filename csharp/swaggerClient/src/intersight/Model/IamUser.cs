...
namespace intersight.Model
{
    ...
    public partial class IamUser :  IEquatable<IamUser>, IValidatableObject
    {
        ...
        public IamUser(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<IamApiKeyRef> ApiKeys = default(List<IamApiKeyRef>), string Email = default(string), IamIdpRef Idp = default(IamIdpRef), IamIdpReferenceRef Idpreference = default(IamIdpReferenceRef), List<IamPermissionRef> Permissions = default(List<IamPermissionRef>), List<IamSessionRef> Sessions = default(List<IamSessionRef>))
        {
