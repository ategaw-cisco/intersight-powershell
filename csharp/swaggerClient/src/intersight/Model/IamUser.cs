...
namespace intersight.Model
{
    ...
    public partial class IamUser :  IEquatable<IamUser>, IValidatableObject
    {
        ...
        /// <param name="Idp">A collection of references to the [iam.Idp](mo://iam.Idp) Managed Object.  When this managed object is deleted, the referenced [iam.Idp](mo://iam.Idp) MO unsets its reference to this deleted MO. .</param>
        /// <param name="Idpreference">A collection of references to the [iam.IdpReference](mo://iam.IdpReference) Managed Object.  When this managed object is deleted, the referenced [iam.IdpReference](mo://iam.IdpReference) MO unsets its reference to this deleted MO. .</param>
        ...
        /// </summary>
        /// <value>A collection of references to the [iam.Idp](mo://iam.Idp) Managed Object.  When this managed object is deleted, the referenced [iam.Idp](mo://iam.Idp) MO unsets its reference to this deleted MO. </value>
        ...
        /// </summary>
        /// <value>A collection of references to the [iam.IdpReference](mo://iam.IdpReference) Managed Object.  When this managed object is deleted, the referenced [iam.IdpReference](mo://iam.IdpReference) MO unsets its reference to this deleted MO. </value>
