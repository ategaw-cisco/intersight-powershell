...
namespace intersight.Model
{
    ...
    public partial class HyperflexNode :  IEquatable<HyperflexNode>, IValidatableObject
    {
        ...
        public HyperflexNode(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), HyperflexClusterRef Cluster = default(HyperflexClusterRef), AssetClusterMemberRef ClusterMember = default(AssetClusterMemberRef), HyperflexHxUuIdDt Identity = default(HyperflexHxUuIdDt), HyperflexHxNetworkAddressDt Ip = default(HyperflexHxNetworkAddressDt), ComputePhysicalRef PhysicalServer = default(ComputePhysicalRef))
        {
