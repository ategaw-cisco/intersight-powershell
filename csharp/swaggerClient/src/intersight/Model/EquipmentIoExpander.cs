...
namespace intersight.Model
{
    ...
    public partial class EquipmentIoExpander :  IEquatable<EquipmentIoExpander>, IValidatableObject
    {
        ...
        public EquipmentIoExpander(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), ComputeBladeRef ComputeBlade = default(ComputeBladeRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
