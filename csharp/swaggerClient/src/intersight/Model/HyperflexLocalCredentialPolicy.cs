...
namespace intersight.Model
{
    ...
    public partial class HyperflexLocalCredentialPolicy :  IEquatable<HyperflexLocalCredentialPolicy>, IValidatableObject
    {
        ...
        public HyperflexLocalCredentialPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), bool? FactoryHypervisorPassword = default(bool?), string HxdpRootPwd = default(string), string HypervisorAdmin = default(string), string HypervisorAdminPwd = default(string), IamAccountRef Organization = default(IamAccountRef))
        {
