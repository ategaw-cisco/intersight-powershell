...
namespace intersight.Model
{
    ...
    public partial class DeviceconnectorPolicy :  IEquatable<DeviceconnectorPolicy>, IValidatableObject
    {
        ...
        public DeviceconnectorPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), bool? LockoutEnabled = default(bool?), IamAccountRef Organization = default(IamAccountRef), List<PolicyAbstractConfigProfileRef> Profiles = default(List<PolicyAbstractConfigProfileRef>))
        {
