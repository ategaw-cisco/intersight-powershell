...
namespace intersight.Model
{
    ...
    public partial class IamIdp :  IEquatable<IamIdp>, IValidatableObject
    {
        ...
        public IamIdp(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamAccountRef Account = default(IamAccountRef), string DomainName = default(string), string Metadata = default(string), string Name = default(string), IamSystemRef System = default(IamSystemRef), List<IamUserLoginTimeRef> UserLoginTime = default(List<IamUserLoginTimeRef>), List<IamUserPreferenceRef> UserPreferences = default(List<IamUserPreferenceRef>), List<IamUserGroupRef> Usergroups = default(List<IamUserGroupRef>), List<IamUserRef> Users = default(List<IamUserRef>))
        {
