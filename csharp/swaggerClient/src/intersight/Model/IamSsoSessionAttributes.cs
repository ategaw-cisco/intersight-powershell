...
namespace intersight.Model
{
    ...
    public partial class IamSsoSessionAttributes :  IEquatable<IamSsoSessionAttributes>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>SAML SessionNotOnOrAfter attribute sent by IdP in the assertion. IdP uses this to control for how long SP session maybe. SP does not issue SLO if the session is not valid.  </value>
        [DataMember(Name="IdpSessionExpiration", EmitDefaultValue=false)]
        public string IdpSessionExpiration { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IdpSessionExpiration: ").Append(IdpSessionExpiration).Append("\n");
        ...
        public bool Equals(IamSsoSessionAttributes other)
        {
            ...
            return 
                (
                    this.IdpSessionExpiration == other.IdpSessionExpiration ||
                    this.IdpSessionExpiration != null &&
                    this.IdpSessionExpiration.Equals(other.IdpSessionExpiration)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IdpSessionExpiration != null)
                    hash = hash * 59 + this.IdpSessionExpiration.GetHashCode();
