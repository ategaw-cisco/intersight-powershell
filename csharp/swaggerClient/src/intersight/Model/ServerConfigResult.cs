...
namespace intersight.Model
{
    ...
    public partial class ServerConfigResult :  IEquatable<ServerConfigResult>, IValidatableObject
    {
        ...
        /// <param name="Profile">A collection of references to the [server.Profile](mo://server.Profile) Managed Object.  When this managed object is deleted, the referenced [server.Profile](mo://server.Profile) MO unsets its reference to this deleted MO. .</param>
        ...
        /// </summary>
        /// <value>A collection of references to the [server.Profile](mo://server.Profile) Managed Object.  When this managed object is deleted, the referenced [server.Profile](mo://server.Profile) MO unsets its reference to this deleted MO. </value>
