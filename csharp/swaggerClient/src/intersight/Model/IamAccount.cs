...
namespace intersight.Model
{
    ...
    public partial class IamAccount :  IEquatable<IamAccount>, IValidatableObject
    {
        ...
        public IamAccount(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<IamDomainGroupRef> DomainGroups = default(List<IamDomainGroupRef>), List<IamEndPointRoleRef> EndPointRoles = default(List<IamEndPointRoleRef>), List<IamIdpReferenceRef> Idpreferences = default(List<IamIdpReferenceRef>), List<IamIdpRef> Idps = default(List<IamIdpRef>), string Name = default(string), List<IamPermissionRef> Permissions = default(List<IamPermissionRef>), List<IamPrivilegeSetRef> PrivilegeSets = default(List<IamPrivilegeSetRef>), List<IamPrivilegeRef> Privileges = default(List<IamPrivilegeRef>), IamResourceLimitsRef ResourceLimits = default(IamResourceLimitsRef), List<IamRoleRef> Roles = default(List<IamRoleRef>), IamSessionLimitsRef SessionLimits = default(IamSessionLimitsRef))
        {
