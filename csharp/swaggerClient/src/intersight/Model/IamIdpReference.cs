...
namespace intersight.Model
{
    ...
    public partial class IamIdpReference :  IEquatable<IamIdpReference>, IValidatableObject
    {
        ...
        /// <param name="MultiFactorAuthentication">Flag represents if multi factor authentication is required for Cisco IdP users.  .</param>
        ...
        public IamIdpReference(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), IamAccountRef Account = default(IamAccountRef), IamIdpRef Idp = default(IamIdpRef), bool? MultiFactorAuthentication = default(bool?), List<IamUserLoginTimeRef> UserLoginTime = default(List<IamUserLoginTimeRef>), List<IamUserPreferenceRef> UserPreferences = default(List<IamUserPreferenceRef>), List<IamUserGroupRef> Usergroups = default(List<IamUserGroupRef>), List<IamUserRef> Users = default(List<IamUserRef>))
        {
