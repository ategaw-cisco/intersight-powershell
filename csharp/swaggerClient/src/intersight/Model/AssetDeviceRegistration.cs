...
namespace intersight.Model
{
    ...
    public partial class AssetDeviceRegistration :  IEquatable<AssetDeviceRegistration>, IValidatableObject
    {
        ...
        public AssetDeviceRegistration(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string AccessKeyId = default(string), IamAccountRef Account = default(IamAccountRef), IamUserRef ClaimedByUser = default(IamUserRef), List<AssetClusterMemberRef> ClusterMembers = default(List<AssetClusterMemberRef>), AssetDeviceClaimRef DeviceClaim = default(AssetDeviceClaimRef), AssetDeviceConfigurationRef DeviceConfiguration = default(AssetDeviceConfigurationRef), List<string> DeviceHostname = default(List<string>), List<string> DeviceIpAddress = default(List<string>), IamDomainGroupRef DomainGroup = default(IamDomainGroupRef), ExecutionModeEnum? ExecutionMode = null, List<string> Pid = default(List<string>), PlatformTypeEnum? PlatformType = null, AssetSecurityTokenRef SecurityToken = default(AssetSecurityTokenRef), List<string> Serial = default(List<string>))
        {
