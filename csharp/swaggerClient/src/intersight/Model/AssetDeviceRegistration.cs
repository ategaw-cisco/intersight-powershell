...
namespace intersight.Model
{
    ...
    public partial class AssetDeviceRegistration :  IEquatable<AssetDeviceRegistration>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates if the platform is an actual device or an emulated device for testing, demos, etc. Permitted values are [Normal, Emulator, ContainerEmulator].  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="AccessKeyId">An identifier for the credential used by the device connector to authenticate with the Intersight web socket gateway.  .</param>
        ...
        /// <param name="ExecutionMode">Indicates if the platform is an actual device or an emulated device for testing, demos, etc. Permitted values are [Normal, Emulator, ContainerEmulator].   (default to null).</param>
        ...
        /// </summary>
        /// <value>An identifier for the credential used by the device connector to authenticate with the Intersight web socket gateway.  </value>
