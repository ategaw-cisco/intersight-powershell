...
namespace intersight.Model
{
    ...
    public partial class IamApiKey :  IEquatable<IamApiKey>, IValidatableObject
    {
        ...
        public IamApiKey(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamPermissionRef Permission = default(IamPermissionRef), string PrivateKey = default(string), string Purpose = default(string), IamUserRef User = default(IamUserRef))
        {
