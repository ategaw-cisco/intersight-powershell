...
namespace intersight.Model
{
    ...
    public partial class IaasUcsdManagedInfra :  IEquatable<IaasUcsdManagedInfra>, IValidatableObject
    {
        ...
        public IaasUcsdManagedInfra(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IaasUcsdInfoRef Guid = default(IaasUcsdInfoRef))
        {
