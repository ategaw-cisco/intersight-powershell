...
namespace intersight.Model
{
    ...
    public partial class EquipmentRackEnclosure :  IEquatable<EquipmentRackEnclosure>, IValidatableObject
    {
        ...
        public EquipmentRackEnclosure(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<EquipmentFanModuleRef> Fanmodules = default(List<EquipmentFanModuleRef>), List<EquipmentPsuRef> Psus = default(List<EquipmentPsuRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<EquipmentRackEnclosureSlotRef> Slots = default(List<EquipmentRackEnclosureSlotRef>))
        {
