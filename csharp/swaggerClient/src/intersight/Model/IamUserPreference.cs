...
namespace intersight.Model
{
    ...
    public partial class IamUserPreference :  IEquatable<IamUserPreference>, IValidatableObject
    {
        ...
        public IamUserPreference(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamIdpRef Idp = default(IamIdpRef), IamIdpReferenceRef IdpReference = default(IamIdpReferenceRef), Object Preference = default(Object))
        {
