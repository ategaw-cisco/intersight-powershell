...
namespace intersight.Model
{
    ...
    public partial class SearchSuggestItem :  IEquatable<SearchSuggestItem>, IValidatableObject
    {
        ...
        /// <param name="SuggestTerm">Main search term used for global search across all Managed Objects that has search enabled.  .</param>
        /// <param name="Top">Maximum number of results to be returned from external search engine.  .</param>
        /// <param name="Type">Object type filter of a Managed Object. Search will be restricted only on the specified object types.  Do not provide IndexMoTypes filter in the rawquery, if you specify values in this field.    .</param>
        ...
        /// </summary>
        /// <value>Main search term used for global search across all Managed Objects that has search enabled.  </value>
        ...
        /// </summary>
        /// <value>Object type filter of a Managed Object. Search will be restricted only on the specified object types.  Do not provide IndexMoTypes filter in the rawquery, if you specify values in this field.    </value>
