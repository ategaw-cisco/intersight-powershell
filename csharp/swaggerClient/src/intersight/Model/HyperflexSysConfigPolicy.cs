...
namespace intersight.Model
{
    ...
    public partial class HyperflexSysConfigPolicy :  IEquatable<HyperflexSysConfigPolicy>, IValidatableObject
    {
        ...
        public HyperflexSysConfigPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), string DnsDomainName = default(string), string DnsServers = default(string), string NtpServers = default(string), IamAccountRef Organization = default(IamAccountRef), string Timezone = default(string))
        {
        ...
        public bool Equals(HyperflexSysConfigPolicy other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.DnsServers.Equals(other.DnsServers)
                ) && 
                (
                    this.NtpServers == other.NtpServers ||
                    this.NtpServers != null &&
                    this.NtpServers.Equals(other.NtpServers)
                ) && 
                (
