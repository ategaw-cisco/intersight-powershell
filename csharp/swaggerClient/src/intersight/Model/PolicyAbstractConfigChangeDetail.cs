...
namespace intersight.Model
{
    ...
    public partial class PolicyAbstractConfigChangeDetail :  IEquatable<PolicyAbstractConfigChangeDetail>, IValidatableObject
    {
        ...
        public PolicyAbstractConfigChangeDetail(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Changes = default(string), PolicyConfigResultContext ConfigChangeContext = default(PolicyConfigResultContext), string Disruptions = default(string), string Message = default(string), ModStatusEnum? ModStatus = ModStatusEnum.None)
        {
