...
namespace intersight.Model
{
    ...
    public partial class AssetClusterMember :  IEquatable<AssetClusterMember>, IValidatableObject
    {
        ...
        public AssetClusterMember(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef Device = default(AssetDeviceRegistrationRef))
        {
