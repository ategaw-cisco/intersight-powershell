...
namespace intersight.Model
{
    ...
    public partial class StorageVirtualDriveExtension :  IEquatable<StorageVirtualDriveExtension>, IValidatableObject
    {
        ...
        public StorageVirtualDriveExtension(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), StorageControllerRef StorageController = default(StorageControllerRef), StorageVirtualDriveRef VirtualDrive = default(StorageVirtualDriveRef))
        {
