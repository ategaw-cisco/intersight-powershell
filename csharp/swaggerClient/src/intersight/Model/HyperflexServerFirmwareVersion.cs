...
namespace intersight.Model
{
    ...
    public partial class HyperflexServerFirmwareVersion :  IEquatable<HyperflexServerFirmwareVersion>, IValidatableObject
    {
        ...
        public HyperflexServerFirmwareVersion(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), HyperflexAppCatalogRef AppCatalog = default(HyperflexAppCatalogRef), List<HyperflexServerFirmwareVersionEntry> ServerFirmwareVersionEntries = default(List<HyperflexServerFirmwareVersionEntry>))
        {
