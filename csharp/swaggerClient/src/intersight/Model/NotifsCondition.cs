...
namespace intersight.Model
{
    ...
    public partial class NotifsCondition :  IEquatable<NotifsCondition>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of change (create, update, delete) performed on the MO.   </value>
        ...
        /// </summary>
        /// <param name="ChangeSet">The list of properties which have been modified while processing a REST request. Applicable only for MO updates, ignored for creation/deletion. Evaluates to True if any of the listed properties have changed or if the list is empty. For example, the list may be set to [&#39;ConnectorStatus&#39;, &#39;ConnectorVersion&#39;].   .</param>
        /// <param name="ChangeType">The type of change (create, update, delete) performed on the MO.    (default to ChangeTypeEnum.Update).</param>
        /// <param name="Filter">The OData-style filter which is evaluated against the state of an MO at the time of transaction commit. An empty filter string evaluates to True. For example, the value may be set to &#39;ConnectionStatus eq &#39;Connected&#39;.    .</param>
        ...
        /// </summary>
        /// <value>The list of properties which have been modified while processing a REST request. Applicable only for MO updates, ignored for creation/deletion. Evaluates to True if any of the listed properties have changed or if the list is empty. For example, the list may be set to [&#39;ConnectorStatus&#39;, &#39;ConnectorVersion&#39;].   </value>
        ...
        /// </summary>
        /// <value>The OData-style filter which is evaluated against the state of an MO at the time of transaction commit. An empty filter string evaluates to True. For example, the value may be set to &#39;ConnectionStatus eq &#39;Connected&#39;.    </value>
