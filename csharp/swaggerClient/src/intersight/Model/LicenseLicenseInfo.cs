...
namespace intersight.Model
{
    ...
    public partial class LicenseLicenseInfo :  IEquatable<LicenseLicenseInfo>, IValidatableObject
    {
        ...
        /// <param name="ActiveAdmin">The license administrative state.  Set this property to &#39;true&#39; to activate the license entitlements.   .</param>
        /// <param name="EvaluationPeriod">The default Trial or Grace period customer is entitled to.  .</param>
        /// <param name="ExtraEvaluation">The number of days the trial Trial or Grace period is extended.  The trial or grace period can be extended once.   .</param>
        /// <param name="TrialAdmin">The administrative state of the trial license.  When the LicenseState is set to &#39;NotLicensed&#39;, &#39;trialAdmin&#39; can be set to true to start the trial period, i.e. licenseState is set to be TrialPeriod.    .</param>
        ...
        /// </summary>
        /// <value>The license administrative state.  Set this property to &#39;true&#39; to activate the license entitlements.   </value>
        ...
        /// </summary>
        /// <value>The number of days left for licenseState to stay in TrialPeriod or OutOfCompliance state.  </value>
        ...
        /// </summary>
        /// <value>The date and time when the trial period expires.  The value of the &#39;endTime&#39; property is set when the account enters the TrialPeriod or OutOfCompliance state.   </value>
        ...
        /// </summary>
        /// <value>The detailed error message when there is any error related to this licensing entitlement.  </value>
        ...
        /// </summary>
        /// <value>The default Trial or Grace period customer is entitled to.  </value>
        ...
        /// </summary>
        /// <value>The number of days the trial Trial or Grace period is extended.  The trial or grace period can be extended once.   </value>
        ...
        /// </summary>
        /// <value>The total number of devices claimed in the Intersight account.  </value>
        ...
        /// </summary>
        /// <value>The license state defined by Intersight.  The value may be one of NotLicensed, TrialPeriod, OutOfCompliance, Compliance, GraceExpired, or TrialExpired.   </value>
        ...
        /// </summary>
        /// <value>The name of the Intersight license entitlement.  For example, this property may be set to &#39;Essentials&#39;.    </value>
        ...
        /// </summary>
        /// <value>The date and time when the licenseState entered a TrialPeriod or OutOfCompliance state.  </value>
        ...
        /// </summary>
        /// <value>The administrative state of the trial license.  When the LicenseState is set to &#39;NotLicensed&#39;, &#39;trialAdmin&#39; can be set to true to start the trial period, i.e. licenseState is set to be TrialPeriod.    </value>
