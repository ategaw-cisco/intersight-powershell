...
namespace intersight.Model
{
    ...
    public partial class HyperflexClusterStoragePolicy :  IEquatable<HyperflexClusterStoragePolicy>, IValidatableObject
    {
        ...
        public HyperflexClusterStoragePolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), bool? DiskPartitionCleanup = default(bool?), HyperflexLogicalAvailabilityZone LogicalAvalabilityZoneConfig = default(HyperflexLogicalAvailabilityZone), IamAccountRef Organization = default(IamAccountRef), bool? VdiOptimization = default(bool?))
        {
