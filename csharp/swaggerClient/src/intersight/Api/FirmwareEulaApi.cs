...
namespace intersight.Api
{
    ...
    public interface IFirmwareEulaApi : IApiAccessor
    {
        ...
        FirmwareEula FirmwareEulasMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<FirmwareEula> FirmwareEulasMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        /// <returns></returns>
        void FirmwareEulasPost (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9);
        ...
        ApiResponse<Object> FirmwareEulasPostWithHttpInfo (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9);
        ...
        System.Threading.Tasks.Task<FirmwareEula> FirmwareEulasMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<FirmwareEula>> FirmwareEulasMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Create an instance of &#39;firmwareEula&#39;
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task FirmwareEulasPostAsync (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> FirmwareEulasPostAsyncWithHttpInfo (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9);
    ...
    public partial class FirmwareEulaApi : IFirmwareEulaApi
    {
        ...
        {
             ApiResponse<FirmwareEulaList> localVarResponse = await FirmwareEulasGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8, count9, inlinecount9, top9, skip9, filter9, select9, orderby9, expand9, apply9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the firmwareEula instance.</param>
        /// <returns>FirmwareEula</returns>
        public FirmwareEula FirmwareEulasMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<FirmwareEula> localVarResponse = FirmwareEulasMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the firmwareEula instance.</param>
        /// <returns>ApiResponse of FirmwareEula</returns>
        public ApiResponse< FirmwareEula > FirmwareEulasMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the firmwareEula instance.</param>
        /// <returns>Task of FirmwareEula</returns>
        public async System.Threading.Tasks.Task<FirmwareEula> FirmwareEulasMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<FirmwareEula> localVarResponse = await FirmwareEulasMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the firmwareEula instance.</param>
        /// <returns>Task of ApiResponse (FirmwareEula)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FirmwareEula>> FirmwareEulasMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling FirmwareEulaApi->FirmwareEulasMoidGet");
        ...
        /// <param name="body9">firmwareEula to add</param>
        /// <returns></returns>
        public void FirmwareEulasPost (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9)
        {
             FirmwareEulasPostWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
        }
        ...
        /// <param name="body9">firmwareEula to add</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> FirmwareEulasPostWithHttpInfo (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9)
        {
        ...
        /// <param name="body9">firmwareEula to add</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task FirmwareEulasPostAsync (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9)
        {
             await FirmwareEulasPostAsyncWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
        ...
        /// <param name="body9">firmwareEula to add</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> FirmwareEulasPostAsyncWithHttpInfo (FirmwareEula body, FirmwareEula body2, FirmwareEula body3, FirmwareEula body4, FirmwareEula body5, FirmwareEula body6, FirmwareEula body7, FirmwareEula body8, FirmwareEula body9)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling FirmwareEulaApi->FirmwareEulasPost");
