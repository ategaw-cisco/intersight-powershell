...
namespace intersight.Api
{
    ...
    public interface IComputeBladeApi : IApiAccessor
    {
        ...
        ComputeBlade ComputeBladesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<ComputeBlade> ComputeBladesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ComputeBlade> ComputeBladesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<ComputeBlade>> ComputeBladesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;computeBlade&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class ComputeBladeApi : IComputeBladeApi
    {
        ...
        /// <param name="moid9">The moid of the computeBlade instance.</param>
        /// <returns>ComputeBlade</returns>
        public ComputeBlade ComputeBladesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeBlade> localVarResponse = ComputeBladesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the computeBlade instance.</param>
        /// <returns>ApiResponse of ComputeBlade</returns>
        public ApiResponse< ComputeBlade > ComputeBladesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the computeBlade instance.</param>
        /// <returns>Task of ComputeBlade</returns>
        public async System.Threading.Tasks.Task<ComputeBlade> ComputeBladesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeBlade> localVarResponse = await ComputeBladesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the computeBlade instance.</param>
        /// <returns>Task of ApiResponse (ComputeBlade)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComputeBlade>> ComputeBladesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling ComputeBladeApi->ComputeBladesMoidGet");
        ...
        {
             ComputeBladesMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeBladesMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             ComputeBladesMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeBladesMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
