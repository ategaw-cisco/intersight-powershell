...
namespace intersight.Api
{
    ...
    public interface IEquipmentChassisApi : IApiAccessor
    {
        ...
        EquipmentChassis EquipmentChassesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<EquipmentChassis> EquipmentChassesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EquipmentChassis> EquipmentChassesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<EquipmentChassis>> EquipmentChassesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;equipmentChassis&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class EquipmentChassisApi : IEquipmentChassisApi
    {
        ...
        /// <param name="moid9">The moid of the equipmentChassis instance.</param>
        /// <returns>EquipmentChassis</returns>
        public EquipmentChassis EquipmentChassesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<EquipmentChassis> localVarResponse = EquipmentChassesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the equipmentChassis instance.</param>
        /// <returns>ApiResponse of EquipmentChassis</returns>
        public ApiResponse< EquipmentChassis > EquipmentChassesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the equipmentChassis instance.</param>
        /// <returns>Task of EquipmentChassis</returns>
        public async System.Threading.Tasks.Task<EquipmentChassis> EquipmentChassesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<EquipmentChassis> localVarResponse = await EquipmentChassesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the equipmentChassis instance.</param>
        /// <returns>Task of ApiResponse (EquipmentChassis)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EquipmentChassis>> EquipmentChassesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling EquipmentChassisApi->EquipmentChassesMoidGet");
        ...
        {
             EquipmentChassesMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await EquipmentChassesMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             EquipmentChassesMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await EquipmentChassesMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
