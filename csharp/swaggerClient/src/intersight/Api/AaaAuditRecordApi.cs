...
namespace intersight.Api
{
    ...
    public interface IAaaAuditRecordApi : IApiAccessor
    {
        ...
        AaaAuditRecord AaaAuditRecordsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<AaaAuditRecord> AaaAuditRecordsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<AaaAuditRecord> AaaAuditRecordsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<AaaAuditRecord>> AaaAuditRecordsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class AaaAuditRecordApi : IAaaAuditRecordApi
    {
        ...
        /// <param name="moid9">The moid of the aaaAuditRecord instance.</param>
        /// <returns>AaaAuditRecord</returns>
        public AaaAuditRecord AaaAuditRecordsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<AaaAuditRecord> localVarResponse = AaaAuditRecordsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the aaaAuditRecord instance.</param>
        /// <returns>ApiResponse of AaaAuditRecord</returns>
        public ApiResponse< AaaAuditRecord > AaaAuditRecordsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the aaaAuditRecord instance.</param>
        /// <returns>Task of AaaAuditRecord</returns>
        public async System.Threading.Tasks.Task<AaaAuditRecord> AaaAuditRecordsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<AaaAuditRecord> localVarResponse = await AaaAuditRecordsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the aaaAuditRecord instance.</param>
        /// <returns>Task of ApiResponse (AaaAuditRecord)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AaaAuditRecord>> AaaAuditRecordsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling AaaAuditRecordApi->AaaAuditRecordsMoidGet");
