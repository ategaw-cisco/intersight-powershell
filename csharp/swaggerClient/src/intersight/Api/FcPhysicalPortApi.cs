...
namespace intersight.Api
{
    ...
    public interface IFcPhysicalPortApi : IApiAccessor
    {
        ...
        FcPhysicalPort FcPhysicalPortsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<FcPhysicalPort> FcPhysicalPortsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<FcPhysicalPort> FcPhysicalPortsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<FcPhysicalPort>> FcPhysicalPortsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;fcPhysicalPort&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class FcPhysicalPortApi : IFcPhysicalPortApi
    {
        ...
        {
             ApiResponse<FcPhysicalPortList> localVarResponse = await FcPhysicalPortsGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8, count9, inlinecount9, top9, skip9, filter9, select9, orderby9, expand9, apply9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the fcPhysicalPort instance.</param>
        /// <returns>FcPhysicalPort</returns>
        public FcPhysicalPort FcPhysicalPortsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<FcPhysicalPort> localVarResponse = FcPhysicalPortsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the fcPhysicalPort instance.</param>
        /// <returns>ApiResponse of FcPhysicalPort</returns>
        public ApiResponse< FcPhysicalPort > FcPhysicalPortsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the fcPhysicalPort instance.</param>
        /// <returns>Task of FcPhysicalPort</returns>
        public async System.Threading.Tasks.Task<FcPhysicalPort> FcPhysicalPortsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<FcPhysicalPort> localVarResponse = await FcPhysicalPortsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the fcPhysicalPort instance.</param>
        /// <returns>Task of ApiResponse (FcPhysicalPort)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FcPhysicalPort>> FcPhysicalPortsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling FcPhysicalPortApi->FcPhysicalPortsMoidGet");
        ...
        {
             FcPhysicalPortsMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await FcPhysicalPortsMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             FcPhysicalPortsMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await FcPhysicalPortsMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
