...
namespace intersight.Api
{
    ...
    public interface IHyperflexNodeApi : IApiAccessor
    {
        ...
        HyperflexNode HyperflexNodesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8);
        ...
        ApiResponse<HyperflexNode> HyperflexNodesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8);
        ...
        System.Threading.Tasks.Task<HyperflexNode> HyperflexNodesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8);
        ...
        System.Threading.Tasks.Task<ApiResponse<HyperflexNode>> HyperflexNodesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8);
    ...
    public partial class HyperflexNodeApi : IHyperflexNodeApi
    {
        ...
        {
             ApiResponse<HyperflexNodeList> localVarResponse = await HyperflexNodesGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8);
             return localVarResponse.Data;
        ...
        /// <param name="moid8">The moid of the hyperflexNode instance.</param>
        /// <returns>HyperflexNode</returns>
        public HyperflexNode HyperflexNodesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8)
        {
             ApiResponse<HyperflexNode> localVarResponse = HyperflexNodesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid8">The moid of the hyperflexNode instance.</param>
        /// <returns>ApiResponse of HyperflexNode</returns>
        public ApiResponse< HyperflexNode > HyperflexNodesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8)
        {
        ...
        /// <param name="moid8">The moid of the hyperflexNode instance.</param>
        /// <returns>Task of HyperflexNode</returns>
        public async System.Threading.Tasks.Task<HyperflexNode> HyperflexNodesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8)
        {
             ApiResponse<HyperflexNode> localVarResponse = await HyperflexNodesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8);
             return localVarResponse.Data;
        ...
        /// <param name="moid8">The moid of the hyperflexNode instance.</param>
        /// <returns>Task of ApiResponse (HyperflexNode)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HyperflexNode>> HyperflexNodesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling HyperflexNodeApi->HyperflexNodesMoidGet");
