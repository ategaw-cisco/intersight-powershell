...
namespace intersight.Api
{
    ...
    public interface IHclSupportedDriverNameApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void HclSupportedDriverNamesPost (HclSupportedDriverName body, HclSupportedDriverName body2, HclSupportedDriverName body3, HclSupportedDriverName body4, HclSupportedDriverName body5, HclSupportedDriverName body6, HclSupportedDriverName body7, HclSupportedDriverName body8, HclSupportedDriverName body9);
    ...
    public partial class HclSupportedDriverNameApi : IHclSupportedDriverNameApi
    {
        ...
        /// <param name="body9">hclSupportedDriverName to add</param>
        /// <returns></returns>
        public void HclSupportedDriverNamesPost (HclSupportedDriverName body, HclSupportedDriverName body2, HclSupportedDriverName body3, HclSupportedDriverName body4, HclSupportedDriverName body5, HclSupportedDriverName body6, HclSupportedDriverName body7, HclSupportedDriverName body8, HclSupportedDriverName body9)
        {
             HclSupportedDriverNamesPostWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
        }
        ...
        {
             await HclSupportedDriverNamesPostAsyncWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
