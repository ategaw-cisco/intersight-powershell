...
namespace intersight.Api
{
    ...
    public interface IIamIdpReferenceApi : IApiAccessor
    {
        ...
        IamIdpReference IamIdpReferencesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<IamIdpReference> IamIdpReferencesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<IamIdpReference> IamIdpReferencesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<IamIdpReference>> IamIdpReferencesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class IamIdpReferenceApi : IIamIdpReferenceApi
    {
        ...
        /// <param name="moid9">The moid of the iamIdpReference instance.</param>
        /// <returns>IamIdpReference</returns>
        public IamIdpReference IamIdpReferencesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IamIdpReference> localVarResponse = IamIdpReferencesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the iamIdpReference instance.</param>
        /// <returns>ApiResponse of IamIdpReference</returns>
        public ApiResponse< IamIdpReference > IamIdpReferencesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the iamIdpReference instance.</param>
        /// <returns>Task of IamIdpReference</returns>
        public async System.Threading.Tasks.Task<IamIdpReference> IamIdpReferencesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IamIdpReference> localVarResponse = await IamIdpReferencesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the iamIdpReference instance.</param>
        /// <returns>Task of ApiResponse (IamIdpReference)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IamIdpReference>> IamIdpReferencesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling IamIdpReferenceApi->IamIdpReferencesMoidGet");
