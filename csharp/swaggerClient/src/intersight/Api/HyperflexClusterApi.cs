...
namespace intersight.Api
{
    ...
    public interface IHyperflexClusterApi : IApiAccessor
    {
        ...
        HyperflexCluster HyperflexClustersMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<HyperflexCluster> HyperflexClustersMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<HyperflexCluster> HyperflexClustersMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<HyperflexCluster>> HyperflexClustersMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;hyperflexCluster&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class HyperflexClusterApi : IHyperflexClusterApi
    {
        ...
        /// <param name="moid9">The moid of the hyperflexCluster instance.</param>
        /// <returns>HyperflexCluster</returns>
        public HyperflexCluster HyperflexClustersMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HyperflexCluster> localVarResponse = HyperflexClustersMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the hyperflexCluster instance.</param>
        /// <returns>ApiResponse of HyperflexCluster</returns>
        public ApiResponse< HyperflexCluster > HyperflexClustersMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
        ...
        /// <param name="moid9">The moid of the hyperflexCluster instance.</param>
        /// <returns>Task of HyperflexCluster</returns>
        public async System.Threading.Tasks.Task<HyperflexCluster> HyperflexClustersMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HyperflexCluster> localVarResponse = await HyperflexClustersMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the hyperflexCluster instance.</param>
        /// <returns>Task of ApiResponse (HyperflexCluster)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HyperflexCluster>> HyperflexClustersMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling HyperflexClusterApi->HyperflexClustersMoidGet");
