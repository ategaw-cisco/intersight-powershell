...
namespace intersight.Api
{
    ...
    public interface IComputeServerSettingApi : IApiAccessor
    {
        ...
        ComputeServerSetting ComputeServerSettingsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<ComputeServerSetting> ComputeServerSettingsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ComputeServerSetting> ComputeServerSettingsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<ComputeServerSetting>> ComputeServerSettingsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;computeServerSetting&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class ComputeServerSettingApi : IComputeServerSettingApi
    {
        ...
        /// <param name="moid9">The moid of the computeServerSetting instance.</param>
        /// <returns>ComputeServerSetting</returns>
        public ComputeServerSetting ComputeServerSettingsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeServerSetting> localVarResponse = ComputeServerSettingsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the computeServerSetting instance.</param>
        /// <returns>ApiResponse of ComputeServerSetting</returns>
        public ApiResponse< ComputeServerSetting > ComputeServerSettingsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the computeServerSetting instance.</param>
        /// <returns>Task of ComputeServerSetting</returns>
        public async System.Threading.Tasks.Task<ComputeServerSetting> ComputeServerSettingsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeServerSetting> localVarResponse = await ComputeServerSettingsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the computeServerSetting instance.</param>
        /// <returns>Task of ApiResponse (ComputeServerSetting)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComputeServerSetting>> ComputeServerSettingsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling ComputeServerSettingApi->ComputeServerSettingsMoidGet");
        ...
        {
             ComputeServerSettingsMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeServerSettingsMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             ComputeServerSettingsMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeServerSettingsMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
