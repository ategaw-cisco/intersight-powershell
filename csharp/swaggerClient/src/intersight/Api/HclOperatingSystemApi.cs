...
namespace intersight.Api
{
    ...
    public interface IHclOperatingSystemApi : IApiAccessor
    {
        ...
        HclOperatingSystem HclOperatingSystemsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<HclOperatingSystem> HclOperatingSystemsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<HclOperatingSystem> HclOperatingSystemsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<HclOperatingSystem>> HclOperatingSystemsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class HclOperatingSystemApi : IHclOperatingSystemApi
    {
        ...
        /// <param name="moid9">The moid of the hclOperatingSystem instance.</param>
        /// <returns>HclOperatingSystem</returns>
        public HclOperatingSystem HclOperatingSystemsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HclOperatingSystem> localVarResponse = HclOperatingSystemsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the hclOperatingSystem instance.</param>
        /// <returns>ApiResponse of HclOperatingSystem</returns>
        public ApiResponse< HclOperatingSystem > HclOperatingSystemsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the hclOperatingSystem instance.</param>
        /// <returns>Task of HclOperatingSystem</returns>
        public async System.Threading.Tasks.Task<HclOperatingSystem> HclOperatingSystemsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HclOperatingSystem> localVarResponse = await HclOperatingSystemsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the hclOperatingSystem instance.</param>
        /// <returns>Task of ApiResponse (HclOperatingSystem)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HclOperatingSystem>> HclOperatingSystemsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling HclOperatingSystemApi->HclOperatingSystemsMoidGet");
