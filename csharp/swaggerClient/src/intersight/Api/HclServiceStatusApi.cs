...
namespace intersight.Api
{
    ...
    public interface IHclServiceStatusApi : IApiAccessor
    {
        ...
        HclServiceStatus HclServiceStatusesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<HclServiceStatus> HclServiceStatusesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<HclServiceStatus> HclServiceStatusesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<HclServiceStatus>> HclServiceStatusesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class HclServiceStatusApi : IHclServiceStatusApi
    {
        ...
        {
             ApiResponse<HclServiceStatusList> localVarResponse = await HclServiceStatusesGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8, count9, inlinecount9, top9, skip9, filter9, select9, orderby9, expand9, apply9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the hclServiceStatus instance.</param>
        /// <returns>HclServiceStatus</returns>
        public HclServiceStatus HclServiceStatusesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HclServiceStatus> localVarResponse = HclServiceStatusesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the hclServiceStatus instance.</param>
        /// <returns>ApiResponse of HclServiceStatus</returns>
        public ApiResponse< HclServiceStatus > HclServiceStatusesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the hclServiceStatus instance.</param>
        /// <returns>Task of HclServiceStatus</returns>
        public async System.Threading.Tasks.Task<HclServiceStatus> HclServiceStatusesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<HclServiceStatus> localVarResponse = await HclServiceStatusesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the hclServiceStatus instance.</param>
        /// <returns>Task of ApiResponse (HclServiceStatus)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HclServiceStatus>> HclServiceStatusesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling HclServiceStatusApi->HclServiceStatusesMoidGet");
