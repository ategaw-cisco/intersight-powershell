...
namespace intersight.Api
{
    ...
    public interface IManagementInterfaceApi : IApiAccessor
    {
        ...
        ManagementInterface ManagementInterfacesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<ManagementInterface> ManagementInterfacesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ManagementInterface> ManagementInterfacesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<ManagementInterface>> ManagementInterfacesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;managementInterface&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class ManagementInterfaceApi : IManagementInterfaceApi
    {
        ...
        /// <param name="moid9">The moid of the managementInterface instance.</param>
        /// <returns>ManagementInterface</returns>
        public ManagementInterface ManagementInterfacesMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ManagementInterface> localVarResponse = ManagementInterfacesMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the managementInterface instance.</param>
        /// <returns>ApiResponse of ManagementInterface</returns>
        public ApiResponse< ManagementInterface > ManagementInterfacesMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the managementInterface instance.</param>
        /// <returns>Task of ManagementInterface</returns>
        public async System.Threading.Tasks.Task<ManagementInterface> ManagementInterfacesMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ManagementInterface> localVarResponse = await ManagementInterfacesMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the managementInterface instance.</param>
        /// <returns>Task of ApiResponse (ManagementInterface)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ManagementInterface>> ManagementInterfacesMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling ManagementInterfaceApi->ManagementInterfacesMoidGet");
        ...
        {
             ManagementInterfacesMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ManagementInterfacesMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             ManagementInterfacesMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ManagementInterfacesMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
