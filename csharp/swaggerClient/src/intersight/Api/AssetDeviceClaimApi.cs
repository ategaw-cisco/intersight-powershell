...
namespace intersight.Api
{
    ...
    public interface IAssetDeviceClaimApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void AssetDeviceClaimsMoidDelete (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<Object> AssetDeviceClaimsMoidDeleteWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        /// <returns></returns>
        void AssetDeviceClaimsPost (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9);
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> AssetDeviceClaimsPostWithHttpInfo (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9);
        ...
        System.Threading.Tasks.Task AssetDeviceClaimsMoidDeleteAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AssetDeviceClaimsMoidDeleteAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Create an instance of &#39;assetDeviceClaim&#39;
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task AssetDeviceClaimsPostAsync (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9);
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> AssetDeviceClaimsPostAsyncWithHttpInfo (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9);
    ...
    public partial class AssetDeviceClaimApi : IAssetDeviceClaimApi
    {
        ...
        /// <param name="moid9">The moid of the assetDeviceClaim instance.</param>
        /// <returns></returns>
        public void AssetDeviceClaimsMoidDelete (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             AssetDeviceClaimsMoidDeleteWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
        }
        ...
        /// <param name="moid9">The moid of the assetDeviceClaim instance.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AssetDeviceClaimsMoidDeleteWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the assetDeviceClaim instance.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AssetDeviceClaimsMoidDeleteAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             await AssetDeviceClaimsMoidDeleteAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
        ...
        /// <param name="moid9">The moid of the assetDeviceClaim instance.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AssetDeviceClaimsMoidDeleteAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling AssetDeviceClaimApi->AssetDeviceClaimsMoidDelete");
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns></returns>
        public void AssetDeviceClaimsPost (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9)
        {
             AssetDeviceClaimsPostWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
        }
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AssetDeviceClaimsPostWithHttpInfo (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9)
        {
        ...
        /// <param name="body9">assetDeviceClaim to add</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AssetDeviceClaimsPostAsync (AssetDeviceClaim body, AssetDeviceClaim body2, AssetDeviceClaim body3, AssetDeviceClaim body4, AssetDeviceClaim body5, AssetDeviceClaim body6, AssetDeviceClaim body7, AssetDeviceClaim body8, AssetDeviceClaim body9)
        {
             await AssetDeviceClaimsPostAsyncWithHttpInfo(body, body2, body3, body4, body5, body6, body7, body8, body9);
