...
namespace intersight.Api
{
    ...
    public interface ILicenseSmartlicenseTokenApi : IApiAccessor
    {
        ...
        LicenseSmartlicenseToken LicenseSmartlicenseTokensMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<LicenseSmartlicenseToken> LicenseSmartlicenseTokensMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        /// <returns></returns>
        void LicenseSmartlicenseTokensMoidPatch (string moid, LicenseSmartlicenseToken body, string moid2, LicenseSmartlicenseToken body2, string moid3, LicenseSmartlicenseToken body3, string moid4, LicenseSmartlicenseToken body4, string moid5, LicenseSmartlicenseToken body5, string moid6, LicenseSmartlicenseToken body6, string moid7, LicenseSmartlicenseToken body7, string moid8, LicenseSmartlicenseToken body8, string moid9, LicenseSmartlicenseToken body9);
        ...
        System.Threading.Tasks.Task<LicenseSmartlicenseToken> LicenseSmartlicenseTokensMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<LicenseSmartlicenseToken>> LicenseSmartlicenseTokensMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;licenseSmartlicenseToken&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class LicenseSmartlicenseTokenApi : ILicenseSmartlicenseTokenApi
    {
        ...
        {
             ApiResponse<LicenseSmartlicenseTokenList> localVarResponse = await LicenseSmartlicenseTokensGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8, count9, inlinecount9, top9, skip9, filter9, select9, orderby9, expand9, apply9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the licenseSmartlicenseToken instance.</param>
        /// <returns>LicenseSmartlicenseToken</returns>
        public LicenseSmartlicenseToken LicenseSmartlicenseTokensMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<LicenseSmartlicenseToken> localVarResponse = LicenseSmartlicenseTokensMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the licenseSmartlicenseToken instance.</param>
        /// <returns>ApiResponse of LicenseSmartlicenseToken</returns>
        public ApiResponse< LicenseSmartlicenseToken > LicenseSmartlicenseTokensMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the licenseSmartlicenseToken instance.</param>
        /// <returns>Task of LicenseSmartlicenseToken</returns>
        public async System.Threading.Tasks.Task<LicenseSmartlicenseToken> LicenseSmartlicenseTokensMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<LicenseSmartlicenseToken> localVarResponse = await LicenseSmartlicenseTokensMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the licenseSmartlicenseToken instance.</param>
        /// <returns>Task of ApiResponse (LicenseSmartlicenseToken)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LicenseSmartlicenseToken>> LicenseSmartlicenseTokensMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling LicenseSmartlicenseTokenApi->LicenseSmartlicenseTokensMoidGet");
        ...
        {
             LicenseSmartlicenseTokensMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await LicenseSmartlicenseTokensMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             LicenseSmartlicenseTokensMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await LicenseSmartlicenseTokensMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
