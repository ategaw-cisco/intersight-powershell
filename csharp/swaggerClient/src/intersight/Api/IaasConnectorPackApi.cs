...
namespace intersight.Api
{
    ...
    public interface IIaasConnectorPackApi : IApiAccessor
    {
        ...
        IaasConnectorPack IaasConnectorPacksMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<IaasConnectorPack> IaasConnectorPacksMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<IaasConnectorPack> IaasConnectorPacksMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<IaasConnectorPack>> IaasConnectorPacksMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class IaasConnectorPackApi : IIaasConnectorPackApi
    {
        ...
        /// <param name="moid9">The moid of the iaasConnectorPack instance.</param>
        /// <returns>IaasConnectorPack</returns>
        public IaasConnectorPack IaasConnectorPacksMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IaasConnectorPack> localVarResponse = IaasConnectorPacksMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the iaasConnectorPack instance.</param>
        /// <returns>ApiResponse of IaasConnectorPack</returns>
        public ApiResponse< IaasConnectorPack > IaasConnectorPacksMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the iaasConnectorPack instance.</param>
        /// <returns>Task of IaasConnectorPack</returns>
        public async System.Threading.Tasks.Task<IaasConnectorPack> IaasConnectorPacksMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IaasConnectorPack> localVarResponse = await IaasConnectorPacksMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the iaasConnectorPack instance.</param>
        /// <returns>Task of ApiResponse (IaasConnectorPack)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IaasConnectorPack>> IaasConnectorPacksMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling IaasConnectorPackApi->IaasConnectorPacksMoidGet");
