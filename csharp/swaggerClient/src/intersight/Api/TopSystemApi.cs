...
namespace intersight.Api
{
    ...
    public interface ITopSystemApi : IApiAccessor
    {
        ...
        TopSystem TopSystemsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<TopSystem> TopSystemsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        /// <returns></returns>
        void TopSystemsMoidPatch (string moid, TopSystem body, string moid2, TopSystem body2, string moid3, TopSystem body3, string moid4, TopSystem body4, string moid5, TopSystem body5, string moid6, TopSystem body6, string moid7, TopSystem body7, string moid8, TopSystem body8, string moid9, TopSystem body9);
        ...
        /// <param name="body9">topSystem to update</param>
        /// <returns></returns>
        void TopSystemsMoidPost (string moid, TopSystem body, string moid2, TopSystem body2, string moid3, TopSystem body3, string moid4, TopSystem body4, string moid5, TopSystem body5, string moid6, TopSystem body6, string moid7, TopSystem body7, string moid8, TopSystem body8, string moid9, TopSystem body9);
        ...
        System.Threading.Tasks.Task<TopSystem> TopSystemsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<TopSystem>> TopSystemsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;topSystem&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class TopSystemApi : ITopSystemApi
    {
        ...
        {
             ApiResponse<TopSystemList> localVarResponse = await TopSystemsGetAsyncWithHttpInfo(count, inlinecount, top, skip, filter, select, orderby, expand, apply, count2, inlinecount2, top2, skip2, filter2, select2, orderby2, expand2, apply2, count3, inlinecount3, top3, skip3, filter3, select3, orderby3, expand3, apply3, count4, inlinecount4, top4, skip4, filter4, select4, orderby4, expand4, apply4, count5, inlinecount5, top5, skip5, filter5, select5, orderby5, expand5, apply5, count6, inlinecount6, top6, skip6, filter6, select6, orderby6, expand6, apply6, count7, inlinecount7, top7, skip7, filter7, select7, orderby7, expand7, apply7, count8, inlinecount8, top8, skip8, filter8, select8, orderby8, expand8, apply8, count9, inlinecount9, top9, skip9, filter9, select9, orderby9, expand9, apply9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the topSystem instance.</param>
        /// <returns>TopSystem</returns>
        public TopSystem TopSystemsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<TopSystem> localVarResponse = TopSystemsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the topSystem instance.</param>
        /// <returns>ApiResponse of TopSystem</returns>
        public ApiResponse< TopSystem > TopSystemsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the topSystem instance.</param>
        /// <returns>Task of TopSystem</returns>
        public async System.Threading.Tasks.Task<TopSystem> TopSystemsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<TopSystem> localVarResponse = await TopSystemsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the topSystem instance.</param>
        /// <returns>Task of ApiResponse (TopSystem)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TopSystem>> TopSystemsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling TopSystemApi->TopSystemsMoidGet");
        ...
        /// <param name="body9">topSystem to update</param>
        /// <returns></returns>
        public void TopSystemsMoidPatch (string moid, TopSystem body, string moid2, TopSystem body2, string moid3, TopSystem body3, string moid4, TopSystem body4, string moid5, TopSystem body5, string moid6, TopSystem body6, string moid7, TopSystem body7, string moid8, TopSystem body8, string moid9, TopSystem body9)
        {
             TopSystemsMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await TopSystemsMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        /// <param name="body9">topSystem to update</param>
        /// <returns></returns>
        public void TopSystemsMoidPost (string moid, TopSystem body, string moid2, TopSystem body2, string moid3, TopSystem body3, string moid4, TopSystem body4, string moid5, TopSystem body5, string moid6, TopSystem body6, string moid7, TopSystem body7, string moid8, TopSystem body8, string moid9, TopSystem body9)
        {
             TopSystemsMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await TopSystemsMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
