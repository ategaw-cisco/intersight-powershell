...
namespace intersight.Api
{
    ...
    public interface IIamDomainGroupApi : IApiAccessor
    {
        ...
        IamDomainGroup IamDomainGroupsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<IamDomainGroup> IamDomainGroupsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<IamDomainGroup> IamDomainGroupsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<IamDomainGroup>> IamDomainGroupsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
    ...
    public partial class IamDomainGroupApi : IIamDomainGroupApi
    {
        ...
        /// <param name="moid9">The moid of the iamDomainGroup instance.</param>
        /// <returns>IamDomainGroup</returns>
        public IamDomainGroup IamDomainGroupsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IamDomainGroup> localVarResponse = IamDomainGroupsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the iamDomainGroup instance.</param>
        /// <returns>ApiResponse of IamDomainGroup</returns>
        public ApiResponse< IamDomainGroup > IamDomainGroupsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the iamDomainGroup instance.</param>
        /// <returns>Task of IamDomainGroup</returns>
        public async System.Threading.Tasks.Task<IamDomainGroup> IamDomainGroupsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<IamDomainGroup> localVarResponse = await IamDomainGroupsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the iamDomainGroup instance.</param>
        /// <returns>Task of ApiResponse (IamDomainGroup)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IamDomainGroup>> IamDomainGroupsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling IamDomainGroupApi->IamDomainGroupsMoidGet");
