...
namespace intersight.Api
{
    ...
    public interface IStorageSasExpanderApi : IApiAccessor
    {
        ...
        StorageSasExpander StorageSasExpandersMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<StorageSasExpander> StorageSasExpandersMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<StorageSasExpander> StorageSasExpandersMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<StorageSasExpander>> StorageSasExpandersMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;storageSasExpander&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class StorageSasExpanderApi : IStorageSasExpanderApi
    {
        ...
        /// <param name="moid9">The moid of the storageSasExpander instance.</param>
        /// <returns>StorageSasExpander</returns>
        public StorageSasExpander StorageSasExpandersMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<StorageSasExpander> localVarResponse = StorageSasExpandersMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the storageSasExpander instance.</param>
        /// <returns>ApiResponse of StorageSasExpander</returns>
        public ApiResponse< StorageSasExpander > StorageSasExpandersMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the storageSasExpander instance.</param>
        /// <returns>Task of StorageSasExpander</returns>
        public async System.Threading.Tasks.Task<StorageSasExpander> StorageSasExpandersMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<StorageSasExpander> localVarResponse = await StorageSasExpandersMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the storageSasExpander instance.</param>
        /// <returns>Task of ApiResponse (StorageSasExpander)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StorageSasExpander>> StorageSasExpandersMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling StorageSasExpanderApi->StorageSasExpandersMoidGet");
        ...
        {
             StorageSasExpandersMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await StorageSasExpandersMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             StorageSasExpandersMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await StorageSasExpandersMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
