...
namespace intersight.Api
{
    ...
    public interface ISecurityUnitApi : IApiAccessor
    {
        ...
        SecurityUnit SecurityUnitsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<SecurityUnit> SecurityUnitsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<SecurityUnit> SecurityUnitsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<SecurityUnit>> SecurityUnitsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;securityUnit&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class SecurityUnitApi : ISecurityUnitApi
    {
        ...
        /// <param name="moid9">The moid of the securityUnit instance.</param>
        /// <returns>SecurityUnit</returns>
        public SecurityUnit SecurityUnitsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<SecurityUnit> localVarResponse = SecurityUnitsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the securityUnit instance.</param>
        /// <returns>ApiResponse of SecurityUnit</returns>
        public ApiResponse< SecurityUnit > SecurityUnitsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the securityUnit instance.</param>
        /// <returns>Task of SecurityUnit</returns>
        public async System.Threading.Tasks.Task<SecurityUnit> SecurityUnitsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<SecurityUnit> localVarResponse = await SecurityUnitsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the securityUnit instance.</param>
        /// <returns>Task of ApiResponse (SecurityUnit)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SecurityUnit>> SecurityUnitsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling SecurityUnitApi->SecurityUnitsMoidGet");
        ...
        {
             SecurityUnitsMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await SecurityUnitsMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             SecurityUnitsMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await SecurityUnitsMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
