...
namespace intersight.Api
{
    ...
    public interface IComputeBoardApi : IApiAccessor
    {
        ...
        ComputeBoard ComputeBoardsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        ApiResponse<ComputeBoard> ComputeBoardsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ComputeBoard> ComputeBoardsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        ...
        System.Threading.Tasks.Task<ApiResponse<ComputeBoard>> ComputeBoardsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9);
        /// <summary>
        /// Update an instance of &#39;computeBoard&#39;
        /// </summary>
        /// <remarks>
    ...
    public partial class ComputeBoardApi : IComputeBoardApi
    {
        ...
        /// <param name="moid9">The moid of the computeBoard instance.</param>
        /// <returns>ComputeBoard</returns>
        public ComputeBoard ComputeBoardsMoidGet (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeBoard> localVarResponse = ComputeBoardsMoidGetWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        }
        ...
        /// <param name="moid9">The moid of the computeBoard instance.</param>
        /// <returns>ApiResponse of ComputeBoard</returns>
        public ApiResponse< ComputeBoard > ComputeBoardsMoidGetWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
        ...
        /// <param name="moid9">The moid of the computeBoard instance.</param>
        /// <returns>Task of ComputeBoard</returns>
        public async System.Threading.Tasks.Task<ComputeBoard> ComputeBoardsMoidGetAsync (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
             ApiResponse<ComputeBoard> localVarResponse = await ComputeBoardsMoidGetAsyncWithHttpInfo(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9);
             return localVarResponse.Data;
        ...
        /// <param name="moid9">The moid of the computeBoard instance.</param>
        /// <returns>Task of ApiResponse (ComputeBoard)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComputeBoard>> ComputeBoardsMoidGetAsyncWithHttpInfo (string moid, string moid2, string moid3, string moid4, string moid5, string moid6, string moid7, string moid8, string moid9)
        {
            // verify the required parameter 'moid' is set
            if (moid == null)
                throw new ApiException(400, "Missing required parameter 'moid' when calling ComputeBoardApi->ComputeBoardsMoidGet");
        ...
        {
             ComputeBoardsMoidPatchWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeBoardsMoidPatchAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        ...
        {
             ComputeBoardsMoidPostWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
        }
        ...
        {
             await ComputeBoardsMoidPostAsyncWithHttpInfo(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9);
